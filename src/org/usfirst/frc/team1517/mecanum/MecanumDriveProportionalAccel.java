...
public class MecanumDriveProportionalAccel {
    ...
    public MecanumDriveProportionalAccel(SpeedController aFront, SpeedController aBack, SpeedController bFront, SpeedController bBack, 
